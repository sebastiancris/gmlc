...
<section class="jumbotron text-center">
        <div class="container">
          ...
          <p>
            <a href="#" class="btn btn-lg btn-secondary my-3">POSTULAR FONDOS CONCURSABLES</a>
            <a href="#" class="btn btn-lg btn-secondary my-3">POSTULAR PROYECTOS</a>
            <a href="#" class="btn btn-lg btn-secondary my-3">INGRESAR CASO</a>
          </p>
        </div>
      </section>
<!-- <div class="container">
