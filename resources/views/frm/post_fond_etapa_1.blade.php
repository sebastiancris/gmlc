         ...
         <div class="card">
            ...
            <div class="card-body">
               <form method="POST" action="{{ route('register') }}">
                  ...
                  <div class="form-group row">
                     <label for="telefono" class="col-md-12 col-form-label text-md-left">{{ __('16. Firmar cláusura de tratamiento de información personal') }}</label>
                     <div class="col-md-1">
                        <input id="telefono" type="checkbox" class="form-control @error('telefono') is-invalid @enderror" name="telefono" autofocus>
                        @error('name')
                        <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                        </span>
